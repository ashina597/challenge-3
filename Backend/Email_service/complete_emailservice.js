...
const complete_emailservice = async (id) => {
    ...
    data.map((item) => {
        ejs_1.default.renderFile('./template/complete.ejs', { title: item.title, description: item.descriptions, date: item.completionDate, submission: item.submission }, async (error, data) => {
            const mailoptions = {
...
exports.default = complete_emailservice;
